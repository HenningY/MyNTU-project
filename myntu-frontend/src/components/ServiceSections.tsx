      ...
      >
        ...
        <div className="text-left">
          <div className="flex items-center gap-1 flex-wrap">
            ...
            <div className="text-xs line-clamp-2 leading-tight font-medium text-[var(--text-500)] max-[1200px]:text-[12px] border border-[var(--nav-border)] rounded-md px-1.5 py-0.5">{courseText1}</div>
            <div className="text-xs line-clamp-2 leading-tight font-medium text-[var(--text-500)] max-[1200px]:text-[12px] border border-[var(--nav-border)] rounded-md px-1.5 py-0.5">{courseText2}</div>
          </div>
